export type GameTurn = 'black' | 'red'
export const GameTurn = {
  BLACK: "black" as GameTurn,
  RED: "red" as GameTurn
}
...
export const TOT_VALUE = 1
export const PHAO_VALUE = 21
export const XE_VALUE = 20
export const MA_VALUE = 19
export const TINH_VALUE = 17
export const SI_VALUE = 18
...
export class GameEngine {
  ...
  constructor(firstTurn: GameTurn = GameTurn.RED) {
  ...
  ableNextPosition(x: number, y: number): Array<ChessManPosition> {
